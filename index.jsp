...
<header class="header">
   ...
   <a href="#" class="logo">Shiv<span>Jyot</span></a>
...
<section class="home" id="home">
   ...
   <div class="swiper home-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <section class="swiper-slide slide" style="background: url(images/goat4.jpeg) no-repeat;">
            <div class="content">
               <h3>Welcome to <span style="color: var(--yellow);" >ShivJyot</span></h3>
               <p>Pet Integrated Farm</p>
               <a href="#about" class="btn">get started</a>
            </div>
         </section>

         <section class="swiper-slide slide" style="background: url(images/goat1.jpg) no-repeat;">
            <div class="content">
               <h3>Better Environment and Best Care for <span style="color: var(--yellow);" >Goats</span> </h3>
             
               <a href="#about" class="btn">get started</a>
            </div>
         </section>

         <section class="swiper-slide slide" style="background: url(images/goat.jpg) no-repeat;">
            <div class="content">
